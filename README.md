...
> **A Claude Code skill that turns the OpenAI Codex CLI into a three-in-one tool: code review, code implementation, and image generation — all through one slash command.**
